...
@Entity
@Table(name = "Clientesfv")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "Clientesfv.findAll", query = "SELECT c FROM Clientesfv c"),
    @NamedQuery(name = "Clientesfv.findByIdCliente", query = "SELECT c FROM Clientesfv c WHERE c.idCliente = :idCliente"),
    @NamedQuery(name = "Clientesfv.findByNombre", query = "SELECT c FROM Clientesfv c WHERE c.nombre = :nombre"),
...
public class Clientesfv implements Serializable {
...
*/
    ...
    public Clientesfv(String idCliente) {
        this.idCliente = idCliente;
    }
  public Clientesfv(String idCliente, String nombre) {
        this.idCliente = idCliente;
        this.nombre = nombre;
       
    }

    public Clientesfv(String idCliente, String nombre, String IdProducto, String NombreProducto, String Cantidad, String Guardado) {
        this.idCliente = idCliente;
        this.nombre = nombre;
        this.IdProducto = IdProducto;
        this.NombreProducto = NombreProducto;
